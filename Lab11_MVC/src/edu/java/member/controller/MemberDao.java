...
// DAO data access object: controller. 프로그램의 주된 기능(business logic).
public interface MemberDao {
	...
	/**
	 * 인덱스를 이용한 검색 기능: 검색할 인덱스를 전달 받아서, 배열에서 해당 인덱스의 Member 객체를 반환
	 * @param index - int 타입. 검색할 (배열의) 인덱스. 0 이상의 정수
	 * @return - index에 null이 아닌 Member 객체가 있으면 그 객체를 리턴.
	 * index가 배열의 범위 밖에 있거나 해당 index의 배열 원소가 null이면 null을 리턴 
	 */
	 ...
	 * @return - 배열에서 회원 정보가 수정이 성공하면 1, 실패하면 0을 리턴.
	 */
